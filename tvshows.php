...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid px-5 mt-5">
            <div class="h2 mb-3">Discover TV Shows</div>
            <div id="discover_tvshows" class="row row-cols-3 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 row-cols-xxl-6 g-4"></div>
        </div>
        ...
        <script>
            fetchMovies("discover_tv", "discover_tvshows");
        </script>
    </body>
</html>